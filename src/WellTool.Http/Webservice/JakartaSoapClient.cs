...
namespace WellTool.Http.Webservice
{
    ...
    /// Jakarta SOAP客户端
    /// <para>
    /// 用于构建SOAP消息并通过HTTP接口发送（兼容Jakarta SOAP规范）。
    /// SOAP消息本质上是XML文本，可以通过调用 GetMsgStr 方法获取消息体。
    /// </para>
    /// <para>使用示例：</para>
    /// <code>
    /// var client = JakartaSoapClient.Create(url)
    ...
    public class JakartaSoapClient
    {
        ...
        private string _url;
        private JakartaSoapProtocol _protocol;
        ...
        {
            _url = url;
            _protocol = JakartaSoapProtocol.SOAP_1_1;
        ...
        /// </summary>
        /// <param name="url">WebService的URL地址</param>
        /// <param name="protocol">协议版本，见<see cref="JakartaSoapProtocol"/></param>
        public JakartaSoapClient(string url, JakartaSoapProtocol protocol) : this(url)
        {
            _protocol = protocol;
            Init(protocol);
        }
        ...
        public JakartaSoapClient(string url, JakartaSoapProtocol protocol, string namespaceUri) : this(url, protocol)
        {
            _namespaceUri = namespaceUri;
        }

        /// <summary>
        /// 创建Jakarta SOAP客户端，默认使用SOAP 1.1版本协议
        /// </summary>
        /// <param name="url">WebService的URL地址</param>
        /// <returns>JakartaSoapClient实例</returns>
        ...
        /// <param name="protocol">协议版本，见<see cref="JakartaSoapProtocol"/></param>
        /// <returns>JakartaSoapClient实例</returns>
        public static JakartaSoapClient Create(string url, JakartaSoapProtocol protocol)
        {
        ...
        /// <param name="namespaceUri">方法上的命名空间URI</param>
        /// <returns>JakartaSoapClient实例</returns>
        public static JakartaSoapClient Create(string url, JakartaSoapProtocol protocol, string namespaceUri)
        {
        ...
        public JakartaSoapClient Init(JakartaSoapProtocol protocol)
        {
            _soapEnvelopeNs = protocol.GetNamespaceUri();
        ...
        /// <returns>this</returns>
        public JakartaSoapClient SetCharset(Encoding charset)
        {
            _charset = charset;
            return this;
        }
        ...
        /// <returns>this</returns>
        public JakartaSoapClient SetCharset(string charsetName)
        {
        ...
        /// <returns>this</returns>
        public JakartaSoapClient AddSoapHeader(string name, string value)
        {
            _headers[name] = value;
            return this;
        }
        ...
        /// <returns>this</returns>
        public JakartaSoapClient SetParam(string name, object value, bool useMethodPrefix)
        {
        ...
        /// <returns>this</returns>
        public JakartaSoapClient SetParams(Dictionary<string, object> parameters)
        {
        ...
        /// <param name="useMethodPrefix">是否使用方法的命名空间前缀</param>
        /// <returns>this</returns>
        public JakartaSoapClient SetParams(Dictionary<string, object> parameters, bool useMethodPrefix)
        {
        ...
        /// <returns>this</returns>
        public JakartaSoapClient Write(Stream outputStream)
        {
        ...
        public async Task<string> SendAsync(bool pretty)
        {
            ...
            if (_protocol == JakartaSoapProtocol.SOAP_1_1)
            {
        ...
        private string GetXmlContentType()
        {
            ...
            {
                JakartaSoapProtocol.SOAP_1_1 => ContentTypeSoap11TextXml + _charset.WebName,
                JakartaSoapProtocol.SOAP_1_2 => ContentTypeSoap12SoapXml + _charset.WebName,
