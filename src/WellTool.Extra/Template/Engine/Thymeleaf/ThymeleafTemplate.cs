...
namespace WellTool.Extra.Template.Engine.Thymeleaf
{
    /// <summary>
    /// Thymeleaf模板实现
    /// </summary>
    public class ThymeleafTemplate : ITemplate
    {
        private readonly string _resource;

        public ThymeleafTemplate(string resource)
        {
            _resource = resource;
        }
