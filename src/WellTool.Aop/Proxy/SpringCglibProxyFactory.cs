...
namespace WellTool.Aop.Proxy
{
    ...
    /// Spring Cglib代理工厂
    /// </summary>
    public class SpringCglibProxyFactory : ProxyFactory
    {
        /// <summary>
        /// 单例实例
        /// </summary>
        public static readonly SpringCglibProxyFactory Instance = new SpringCglibProxyFactory();
        ...
        {
            // 注意：C#中没有原生的Spring Cglib库，这里使用占位实现
