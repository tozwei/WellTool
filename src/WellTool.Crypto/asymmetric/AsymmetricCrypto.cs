...
namespace WellTool.Crypto.Asymmetric
{
    ...
    public abstract class AsymmetricCrypto
    {
        ...
        /// 加密算法
        /// </summary>
        protected readonly AsymmetricAlgorithm Algorithm;
        ...
        protected AsymmetricCrypto(AsymmetricAlgorithm algorithm, byte[] publicKey, byte[]? privateKey = null)
        {
            Algorithm = algorithm;
            PublicKey = publicKey ?? throw new CryptoException("Public key cannot be null");
