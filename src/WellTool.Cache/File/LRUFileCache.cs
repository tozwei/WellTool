...
namespace WellTool.Cache.File
{
    ...
    /// </summary>
    public class LRUFileCache : AbstractFileCache
    {
        ...
        /// 缓存实现
        /// </summary>
        private readonly LRUCacheInner _cache;
        ...
        {
            _cache = new LRUCacheInner(capacity, timeout, this);
        }
        ...
        /// 内部LRU缓存实现
        /// </summary>
        private class LRUCacheInner : LRUCache<FileInfo, byte[]>
        {
            private readonly LRUFileCache _outer;

            public LRUCacheInner(int capacity, long timeout, LRUFileCache outer)
