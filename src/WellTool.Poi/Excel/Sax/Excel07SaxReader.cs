...
/// Excel07 SAX读取器
/// </summary>
public class Excel07SaxReader : IExcelSaxReader
{
	/// <summary>
	/// RID前缀
	/// </summary>
	...
	public Excel07SaxReader(IRowHandler rowHandler)
	{
	...
	public IExcelSaxReader Read(Stream inStream, string idOrRidOrSheetName)
	{
		...
		try
		{
			...
			{
				throw new ArgumentException($"Sheet [{idOrRidOrSheetName}] not found");
			}
