...
namespace WellTool.Core.Map
{
    /// <summary>
        ...
        public static class MapUtil
        {
            ...
            public static Dictionary<K, V> filter<K, V>(Dictionary<K, V> map, Filter<KeyValuePair<K, V>> filter)
            {
            ...
            {
                private readonly Filter<KeyValuePair<K, V>> _filter;

                public FilterEditor(Filter<KeyValuePair<K, V>> filter)
                {
                    _filter = filter;
                }
