...
{
    /// <summary>
    /// 扫描<see cref="FieldInfo"/>上的注解
    /// </summary>
    public class FieldAnnotationScanner : IAnnotationScanner
    {
        /// <summary>
        /// 判断是否支持扫描该注解元素，仅当注解元素是<see cref="FieldInfo"/>时返回<see langword="true"/>
        /// </summary>
        ...
        {
            return annotatedEle is FieldInfo;
        }
        ...
        {
            var field = (FieldInfo)annotatedEle;
        ...
        /// <summary>
        /// 扫描<see cref="FieldInfo"/>上直接声明的注解，调用前需要确保调用<see cref="Support(object)"/>返回为true
        /// </summary>
