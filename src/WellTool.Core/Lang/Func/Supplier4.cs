...
namespace WellTool.Core.Lang.Func
{
    ...
    public delegate T Supplier4<out T, in P1, in P2, in P3, in P4>(P1 p1, P2 p2, P3 p3, P4 p4);

    /// <summary>
    /// Supplier4 扩展方法
    /// </summary>
    public static class Supplier4Extensions
    {
        /// <summary>
        ...
        public static System.Func<T> ToSupplier<T, P1, P2, P3, P4>(this Supplier4<T, P1, P2, P3, P4> supplier, P1 p1, P2 p2, P3 p3, P4 p4)
        {
            return () => supplier(p1, p2, p3, p4);
        }
    }
}