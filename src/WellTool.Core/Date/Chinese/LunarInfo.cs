...
namespace WellTool.Core.Date.Chinese
{
    ...
    public class LunarInfo
    {
        ...
        /// 1900年
        /// </summary>
        public static readonly int BASE_YEAR = 1900;
        /// <summary>
        /// 1900-01-31，农历正月初一
        /// </summary>
        public static readonly long BASE_DAY;

        static LunarInfo()
        {
            var baseDate = new DateTime(BASE_YEAR, 1, 31);
            var epoch = new DateTime(1970, 1, 1);
            BASE_DAY = (baseDate - epoch).Days;
        }
        ...
        /// </summary>
        private static readonly long[] LUNAR_CODE = new long[]{
        ...
        // 支持的最大年限
        public static readonly int MAX_YEAR = BASE_YEAR + LUNAR_CODE.Length - 1;
